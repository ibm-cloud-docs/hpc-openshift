...
Before you begin using the {{site.data.keyword.bplong}} API to deploy {{site.data.keyword.redhat_openshift_full}} for HPC, review and complete the following prerequisites: 
...
After you've reviewed and completed the prerequisites for setting up the API, you are ready to [Create a workspace](/docs/hpc-openshift?topic=hpc-openshift-creating-workspace&interface=api).
...
1. In the {{site.data.keyword.cloud_notm}} console on the **Schematics > Workspaces** page, select **Actions > Delete workspace** to delete the {{site.data.keyword.bpshort}} workspace.
...
2. Copy and paste the [Delete a workspace using Schematics Python API](/docs/hpc-openshift?topic=hpc-openshift-deleting-workspace&interface=api#example-request-delete-workspace) example request to your Python file.

...
If you don't need the {{site.data.keyword.redhat_openshift_full}} cluster and want to destroy all of its associated VPC resources, you can remove them from your {{site.data.keyword.cloud}} account.
...
2. Copy and paste the [Destroy resources using Schematics Python API](/docs/hpc-openshift?topic=hpc-openshift-deleting-resources&interface=api#example-request-destroy) example request to your Python file.
